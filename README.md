...
- Press `<leader>cn` to create a new Claude Code instance (always uses plain `claude` without flags)
...
- `:ClaudeCodeNew` - Create a new Claude Code instance (always uses plain `claude` command).
